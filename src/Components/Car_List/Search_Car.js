    ...
    <>
      ...
      <div className="bg-white">
        <div className="pt-4 mr-5 flex justify-center">
          <i
            className="relative top-2 left-10 text-lg 
          text-grey hover:text-B-yellow bi bi-search"
          ></i>
          <input
            type="text"
            placeholder="Search..."
            ...
            className="rounded-full py-2 px-5 mb-4 bg-G-white text-black w-full md:w-2/4 border-2 border-B-yellow"
          />

          {searchQuery === "" ? null : (
            <i
              className="relative top-2 right-10 text-xl 
          text-grey hover:text-B-yellow cursor-pointer bi bi-x-circle-fill"
              onClick={resetSearch}
            ></i>
          )}
        </div>
