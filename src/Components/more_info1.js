...
export const Info1 = () => {
    ...
    <>
      ...
      <div className="bg-white ">
        <div className="flex flex-col justify-between pt-4 px-4 md:flex-row">
          <h2 className="font-bold text-4xl mb-4 md:mb-0"><span className="underline decoration-B-yellow">Buga</span>tti Chiron</h2>
  ...
  <div className="w-full md:w-3/4">
    <img src="assets/car1.jpg" alt="" className="w-full rounded-2xl" />
  </div>

  <div className="bg-L-black p-2 rounded-2xl flex flex-col h-full text-white items-center text-center">
    <p className="p-2 bg-B-yellow text-L-black w-72 rounded-2xl font-bold">
      Duty-Paid
    </p>
    ...
    <div className="text-L-black bg-B-yellow rounded-2xl p-2 text-left w-full mb-2">
      ...
      <p>123 *******</p>
      <p className="hover:underline decoration-L-black">Send an email</p>
      <a
        href="https://www.bugatti.com/"
        className="hover:underline decoration-L-black"
      >
        Website
      </a>
    </div>
    <button className="border-2 border-B-yellow rounded-full w-2/4 py-2 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-150 hover:bg-B-yellow hover:text-L-black font-bold">
      Rent Now
    </button>
  </div>
</div>
